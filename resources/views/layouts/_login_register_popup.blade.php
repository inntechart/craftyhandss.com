        ...
        <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-2-title">
            ...
            <main class="modal__content " id="modal-2-content">
                ...
                <form id="register-form" class="registration-form" method="POST" action="{{ route('register') }}" autocomplete="off">
                    ...
                    <button id="reg-button" type="submit" data-submit="Register" class="btn">Einreichen</button>
                ...
                <form id="login-form" method="POST" class="login-form registration-form" action="{{ route('login') }}" autocomplete="off">
                    ...
                    <fieldset>
                        <div class="input-field" style="width: 100%;">
                            <label>Email:</label>
                            <input style="width: 95% !important;" placeholder="" type="email" name="loginemail" value="{{ old('email') }}" required readonly="readonly" onfocus="javascript: this.removeAttribute('readonly')"/>
                        </div>
                    </fieldset>
                    <fieldset>
                        <div class="input-field" style="width: 100%;">
                            <label>Passwort:</label>
                            <input style="width: 95% !important;" type="password" name="loginpassword" value="" autocomplete="anyrandomstring" required readonly="readonly" onfocus="javascript: this.removeAttribute('readonly')"/>
                        </div>
                    </fieldset>
                    <button id="login-form-button" type="submit" data-submit="login" class="btn">Anmeldung</button>
